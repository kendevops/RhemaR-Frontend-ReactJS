...
type UploadVideoForSessionModalProps = {
  isOpen: boolean;
  toggle: VoidFunction;
};

export default function UploadVideoForSessionModal({
  isOpen,
  toggle,
}: UploadVideoForSessionModalProps) {
  ...
  const onDrop = useCallback((acceptedFiles) => {
    ...
    formData.video = acceptedFiles;

    updateForm("video", acceptedFiles);
    console.log(acceptedFiles, formData.video);
  }, []);
