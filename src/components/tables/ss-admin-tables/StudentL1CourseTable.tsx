...
export default function StudentL1CoursesTable() {
    ...
    <>
      <div className="my-3 d-flex  justify-content-between">
        <div className="d-flex flex-column gap-3 " style={{ fontSize: "20px" }}>
          <div className=" ">L1 Start Date: 28th April 2023</div>
          <div>L1 End Date: 28th April 2023</div>
        </div>

        <div className="d-flex flex-column gap-3 " style={{ fontSize: "20px" }}>
          <div className=" ">Total Course Completed: 20</div>
          <div>Total Course Outstanding: 7</div>
        </div>
