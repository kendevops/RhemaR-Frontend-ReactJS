...
const instructorAdminRoutes = [
  {
    path: "/student-service-admin/dashboard",
  ...
  {
    path: "/student-service-admin/user-management",
  ...
  {
    path: "/student-service-admin/admin-management",
  ...
  {
    path: "/student-service-admin/academic-management",
  ...
  {
    path: "/student-service-admin/student-services-admin",
  ...
  {
    path: "/student-service-admin/tuition-management",
  ...
  {
    path: "/student-service-admin/roles-privilleges",
...
export default instructorAdminRoutes;
