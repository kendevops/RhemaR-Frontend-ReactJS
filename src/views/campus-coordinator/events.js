		...
		<>
			<div className="container my-5">
				<app-banner-with-pattern
					title="Events"
					img="upcoming-event.svg"></app-banner-with-pattern>
					...
					<p className="r-card-title d-flex justify-content-between align-items-center mb-4">
						<span className="d-flex justify-content-between align-items-center">
							<span className="me-2">
								<span
									className="iconify"
									data-icon="bx:bxs-calendar-alt"></span>
							</span>
							January 2022
						</span>
						<span className="d-flex justify-content-between align-items-center">
					...
					<div className="py-4 px-5">
						<div className="row">
							<div className="col-lg-4 col-md-6 col-12">
								<app-event-card link="/campus-coordinator/live-event/live-event/1"></app-event-card>
							</div>
						</div>
					</div>
				</div>
