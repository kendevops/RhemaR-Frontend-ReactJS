...
import { getHomeRouteForLoggedInUser } from "../../utility/utilsGeneric";

const MiscNotAuthorized = () => {
  const { currentRole } = useContext(RoleContext);

  const home = getHomeRouteForLoggedInUser(currentRole);

  console.log({ currentRole, home });
  // ** Hooks
  const { skin } = useSkin();
      ...
      <div className="misc-inner p-2 p-sm-3">
        <div className="w-100 text-center">
          ...
          <Button
            ...
            to={home}
            color="primary"
            className="btn btn-lg btn-blue-600 my-3"
          >
            Back to Home
          </Button>
        </div>
...
export default MiscNotAuthorized;
